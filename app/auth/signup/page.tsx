...
export default function SignUpPage() {
  ...
  const handleGoogleSignIn = async () => {
    setIsLoading(true);
    try {
      await signIn('google', { callbackUrl: role === 'vendor' ? '/vendor/dashboard' : '/' });
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-orange-50 via-white to-red-50 py-12 px-4">
        ...
        <CardHeader className="text-center space-y-4 pb-8">
          ...
          <div className="space-y-2">
            ...
            <CardDescription className="text-base">
              Create your account and start booking amazing services
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Tabs defaultValue="customer" onValueChange={setRole} className="w-full">
                <TabsList className="grid w-full grid-cols-2 h-auto p-1 bg-gray-100 rounded-xl">
                  <TabsTrigger
                    value="customer"
                    className="rounded-lg py-3 data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all"
                  >
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/auth/signin" className="font-semibold text-orange-600 hover:text-orange-700 hover:underline">
                Sign in
              </Link>
            </p>
          </div>
